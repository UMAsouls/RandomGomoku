...
class Mass(IMass,CreatingMass):
    ...
    def SetStone(self, stone: Stone) -> bool:
        ...
        ans1 = self.Count((0,0),0,self.stone) + self.Count((2,2),0,self.stone) - 1 >= 4
        ans2 = self.Count((0,1),0,self.stone) + self.Count((2,1),0,self.stone) - 1 >= 4
        ans3 = self.Count((0,2),0,self.stone) + self.Count((2,0),0,self.stone) - 1 >= 4
        ans4 = self.Count((1,0),0,self.stone) + self.Count((1,2),0,self.stone) - 1 >= 4
